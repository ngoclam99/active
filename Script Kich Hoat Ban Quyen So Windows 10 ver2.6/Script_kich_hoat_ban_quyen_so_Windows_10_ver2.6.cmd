...
color f0
title Cong cu kich hoat ban quyen so Windows 10 by WindowsAddict ver2.6
::===========================================================================
...
if not exist %gatherosstate% (
	call :Footer
	echo Khong tim thay file gatherosstate.exe. Nhap ky tu o dia ISO de sao chep...
	call :Footer
...
call :Footer
echo  Khoa san pham mac dinh duoc cai dat danh cho Windows 10 %edition% %vera%...
echo:
...
timeout /t 3 >nul 2>&1
call :Footer
echo Tep GenuineTicket.XML dang cai dat cho Windows 10 %edition% %vera%...
echo:
clipup -v -o -altto bin\%vera%\
call :Footer
echo Windows 10 %edition% %vera% dang kich hoat...
echo:
...
echo. :=======================================================:
Echo.     [1] Chen key mac dinh
Echo.
Echo.     [2] Xoa key mac dinh
echo.
echo. (Xem HD-SD.txt de hieu viec su dung cac tuy chon o tren)
echo.
Echo.     [3] Kiem tra cap nhat cong cu kich hoat
Echo.       
Echo.     [4] Chuyen den Menu chinh
echo. :=======================================================:
choice /C:1234 /N /M "Enter Your Choice [1,2,3,4] : "
if errorlevel 4 goto :GoToMainMenu
if errorlevel 3 goto :CheckForUpdates
if errorlevel 2 goto :RemoveKey
...
CLS
mode con cols=85 lines=10
echo Dang go cai dat key mac dinh cho Windows 10 %edition% %vera%...
echo:
